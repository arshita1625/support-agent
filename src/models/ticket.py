#!/usr/bin/env python3
"""Support ticket models using Python dataclasses."""
...
@dataclass
class SupportTicket:
    """Incoming support ticket for processing."""
    ...
    def __post_init__(self):
        ...
        # Clean and validate ticket text
    ...
    def get_word_count(self) -> int:
        """Get word count of ticket text."""
        return len(self.ticket_text.split())
    
    def extract_keywords(self) -> List[str]:
        """Extract potential keywords from ticket text."""
        ...
        keyword_categories = {
            ...
            # NEW: Support and service keywords
    ...
    def categorize_automatically(self) -> str:
        """Automatically suggest a category based on content."""
...
if __name__ == "__main__":
    print("🧪 Testing Support Ticket Model...")
    
    # Test valid ticket
    ticket = SupportTicket(
        ticket_text="From where can i talk to customer service?",
        priority="low",
        category="customer service",
        customer_id="customer_123"
    )
    
    print(f"✅ Ticket: {ticket.ticket_id[:8]}...")
    print(f"   Priority: {ticket.priority}")
    print(f"   Category: {ticket.category}")
    print(f"   Word count: {ticket.get_word_count()}")
    print(f"   Keywords: {ticket.extract_keywords()}")
    
    # Test serialization
    ticket_dict = ticket.to_dict()
    ticket_restored = SupportTicket.from_dict(ticket_dict)
    print(f"✅ Serialization works - Restored ticket: {ticket_restored.ticket_id[:8]}...")
    
    # Test validation
    try:
        invalid_ticket = SupportTicket(ticket_text="short")
        print("❌ Should have failed validation")
    except ValueError as e:
        print(f"✅ Validation works - Caught error: {str(e)[:50]}...")
    
    print("🎉 Support ticket model working correctly!")
